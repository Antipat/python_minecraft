...
# Linux
## Инструкция по установке лаунчера Minecraft и сервера для программирования
## читайте на данном сайте https://learnlange.blogspot.com/2026/02/minecraft-python-linux.html 

# WINDOWS
## Добавил сервер для последней на сегодняшней день версии Minecraft 1.21.8 Настроен под Python 3.10 и выше
